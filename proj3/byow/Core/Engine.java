...
public class Engine {
    ...
    public void interactWithKeyboard() {
        ...
        StdDraw.picture(0.5,0.65, "byow/Core/star.png");
        ...
        while (inputSource.possibleNextInput()) {
            ...
            if (nextchar == 'N') {
                ...
                StdDraw.picture(0.82,0.18, "byow/Core/alien.png");
                StdDraw.show();
                while (inputSource.possibleNextInput()) {
                    char c = inputSource.getNextKey();
                    if (c == 'M') {
    ...
    private void moveCharacter(char choide) {
        ...
        switch (choide) {
            case 'W':
                if ((world[charX][charY + 1].description().equals("purple"))){
                    break;
                    ...
                    world[charX][charY+1] = Tileset.SMILE;
            ...
            case 'D':
                if ((world[charX + 1][charY].description().equals("purple"))){
                    break;
                    ...
                    world[charX + 1][charY] = Tileset.SMILE;
                    world[charX][charY] = Tileset.FLOOR;
                    charX += 1;
                    break;
                }
    ...
    private void outcomeDisplay(String s){
        ...
        StdDraw.picture(0.5,0.20, "byow/Core/UFO.png");
        StdDraw.show();
        KeyboardInputSource inputSource;
        inputSource = new KeyboardInputSource();
        while (inputSource.possibleNextInput()) {
            ...
            if (nextchar == 'P') {
                ...
                while (timer < 13) {
                    ...
                    StdDraw.enableDoubleBuffering();
                    StdDraw.clear(Color.black);
                    StdDraw.picture(x, y, "byow/Core/UFO.png");
                    StdDraw.show();
                    y = y + mover;
                    if (y>0.5){
                        x = x+mover;
...
StdDraw.enableDoubleBuffering();
  ...
  ter.renderFrame(world);
    ...
    private class KeyboardInputSource implements InputSource {
